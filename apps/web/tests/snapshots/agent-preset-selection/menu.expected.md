- menu:
  ...
  - 'menuitem "Peck mode The Peck product''s standard coding agent: full Standard capabilities, the Peck persona, and opt-in Peck host packages (disabled by default)."'
