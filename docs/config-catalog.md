...
Requires: `agentDefaultModel` · `agents` · `attachments` · `directoryPicker` · `llm` · `sessions` · `subagents` · `sessionQuery` · `tools` · `workspaceRegistry`
...
Source: [`packages/llm/llm-claude-cli/src/index.ts:52`](../packages/llm/llm-claude-cli/src/index.ts)
...
- `@deepseek-ai/dsh-session-metered-receipt` — requires `sessionProjections` ([`packages/session/session-metered-receipt/src/index.ts`](../packages/session/session-metered-receipt/src/index.ts))
...
- `@deepseek-ai/dsh-session-usage` — requires `sessionProjections` ([`packages/session/session-usage/src/index.ts`](../packages/session/session-usage/src/index.ts))
