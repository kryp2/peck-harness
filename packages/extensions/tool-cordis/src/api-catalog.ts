...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  {
    key: 'userQuestions',
    summary: '`ctx.userQuestions`: validation plus the scoped answerer race.',
    description: '`ctx.userQuestions`: validation plus the scoped answerer race.',
    methods: [
      {
      ...
      },
      {
        ...
        throws: ['{UserQuestionError} code `ASK_ABORTED` when the supplied signal is already or becomes aborted, `CALLER_NOT_LIVE` when a supplied agent is not the registry\'s exact live instance, `DELEGATED_CALLER` when that live agent is owned by another agent, or `NO_ANSWERER` when no answerer is composed (fail closed).'],
      },
    ],
  },
  {
